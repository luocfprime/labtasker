# connect-project — realistic workflow, version 1

Durable project endpoint/Queue selection and actual existing script submission in requested Queue; no unintended Server/local daemon or unrelated Queue Task. Accept documented config/environment project mechanism if persistent and reproducibly selected.

Provision with `uv run python tests/skill/cases/connect-project/scripts/run.py setup`
