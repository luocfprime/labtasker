...
def test_openapi_describes_the_complete_v2_surface_and_real_response_statuses(
    ...
    expected_methods = {
        ...
        "/api/v2/queues/{queue}/workers": {"get"},
        "/api/v2/queues/{queue}/workers/count": {"get"},
        "/api/v2/queues/{queue}/workers/{id}": {"put", "delete"},
        "/api/v2/queues/{queue}/workers/{id}/telemetry": {"post"},
